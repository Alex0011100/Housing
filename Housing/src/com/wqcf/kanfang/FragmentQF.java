...
public class FragmentQF extends BaseNetFragment implements IXListViewListener,OnItemClickListener{
	...
	private TextHttpResponseHandler httpHandler = new TextHttpResponseHandler(){
		...
		public void onSuccess(int statusCode, Header[] headers,
			...
			Logger.log("qf_response", responseString);
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle saveInstanceState){
		View view = inflater.inflate(R.layout.fragment_act_infolist_qifang, null);
		...
		params.put(QueryParam.PARAM_TRADE_TYPE,QueryParam.TRADE_TYPE_FUTURE_HOUSE);
